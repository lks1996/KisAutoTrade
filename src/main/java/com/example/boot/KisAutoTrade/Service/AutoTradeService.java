...
public class AutoTradeService {
    ...
    public DomesticStockService domesticStockService;
    public SheetDataImportService sheetDataImportService;
    ...
    public void execute() throws Exception {
        ...
        // 2. 잔고 조회
        StockDto stockBalanceDto = new StockDto();
        domesticStockService.getBalance(stockBalanceDto);
